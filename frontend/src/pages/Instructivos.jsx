...
import bannerInstructivo from '../assets/img/banners-web/instructivo.jpg'
...
export default function Instructivos() {
  ...
  return (
    <>
      {/* HERO */}
      <header className="page-hero" style={{ backgroundImage: `linear-gradient(135deg, rgba(14,23,48,0.45) 0%, rgba(27,79,174,0.30) 100%), url(${bannerInstructivo})` }}>
