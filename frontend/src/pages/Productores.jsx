    ...
    <>
      ...
      <section className="section proceso" id="beneficios">
        ...
        <div className="proc-grid">
          ...
          <div className="proc-item reveal delay-3"><div className="proc-num" style={{ background: 'var(--success)' }}><svg className="icon" style={{ color: 'var(--dark)', width: '22px' }}><use href="#i-doc" /></svg></div><h4>Capacitaciones y Networking</h4><p>Charlas, capacitaciones y eventos exclusivos para generar vínculos y nuevas oportunidades.</p></div>
        </div>
      </section>
